...
const CelestialMatrixShader = ({ className, style }: Props) => {
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Green palette matching #3fb950 portfolio accent
        vec3 color1 = vec3(0.05, 0.40, 0.15);
        vec3 color2 = vec3(0.12, 0.73, 0.31);
